...
This script requires a folder containing bam files with sequencing data and a text file located inside the folder listing each of the bam files. If you want the files to be separated by high/low ctDNA the files should be named as follows:
