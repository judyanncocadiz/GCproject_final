---
title: "03_Promoter_patterns_lowinallpromoters"
...
get_open_genes_by_high_ratio <- function(id, df){
  ...
  png(file=paste0(output, "/promoter_patterns/plots/low_in_all/visualise_clusters_with_fviz/", id, ".png"))
...
get_open_genes_by_proportion <- function(id, df){
  ...
  ggsave(paste0(output, "/promoter_patterns/plots/low_in_all/cluster_plots/", id, ".cluster1.png"),
  ...
  ggsave(paste0(output, "/promoter_patterns/plots/low_in_all/cluster_plots/", id, ".cluster2.png"),
...
for(i in all_samples){
  print(i)
  df <- readRDS(paste0(output, "/promoter_patterns/pro_counts/low_in_all/", i, ".RDS"))
  open_genes <- get_open_genes_by_high_ratio(i, df)
  write_lines(open_genes, paste0(output, "/promoter_patterns/potential_open_genes/low_in_all/byratio/", i, "byratio.txt"))
}
...
for(i in all_samples){
  ...
  write_lines(open_genes, paste0(output, "/promoter_patterns/potential_open_genes/low_in_all/byprop/", i, "byprop.txt"))
}
...
for(i in all_samples){
  ...
  write_lines(open_genes, paste0(output, "/promoter_patterns/potential_open_genes/low_in_all/byquant/", i, ".byquant.txt"))
}
...
for(i in all_samples){
  sample_open_genes <- read_lines(paste0(output,
                                       "/promoter_patterns/potential_open_genes/low_in_all/byratio/",
                                       i, "byratio.txt"))
...
sig_results
write_lines(sig_results, paste0(output, "/promoter_patterns/high_gc_sig_open_genes/low_in_all/high_gc_sig_open_genes_byratio.txt"))
output
prmtr_yes_no[names(prmtr_yes_no) %in% sig_results]

healthy_enriched <- sig_results[1:4]
stad_enriched <- sig_results[5:length(sig_results)]
...
write_tsv(stad_enriched_genes_by_ratio,
          paste0(output, "/promoter_patterns/ready_to_phenogram/low_in_all/stad_enriched_by_ratio.tsv"))
...
write_tsv(healthy_enriched_genes_by_ratio,
          paste0(output, "/promoter_patterns/ready_to_phenogram/low_in_all/healthy_enriched_by_ratio.tsv"))
...
for(i in all_samples){
  sample_open_genes <- read_lines(paste0(output,
                                       "/promoter_patterns/potential_open_genes/low_in_all/byprop/",
                                       i, "byprop.txt"))
  all_open_genes[[count]] <- sample_open_genes
  names(all_open_genes)[count] <- i
  count <- count +1
...
sig_results <- results[results$p.adj < 0.05,]$gene
sig_results
write_lines(sig_results, paste0(output, "/promoter_patterns/high_gc_sig_open_genes/low_in_all/high_gc_sig_open_genes_byprop.txt"))
prmtr_yes_no[names(prmtr_yes_no) %in% sig_results]

healthy_enriched <- sig_results[c(1)]
stad_enriched <- sig_results[1:length(sig_results)]
...
write_tsv(stad_enriched_genes_by_prop,
          paste0(output, "/promoter_patterns/ready_to_phenogram/low_in_all/stad_enriched_by_prop.tsv"))
length(healthy_enriched)
...
nrow(healthy_enriched_genes_by_ratio)
write_tsv(healthy_enriched_genes_by_ratio,
          paste0(output, "/promoter_patterns/ready_to_phenogram/low_in_all/healthy_enriched_by_prop.tsv"))
...
for(i in all_samples){
  sample_open_genes <- read_lines(paste0(output,
                                       "/promoter_patterns/potential_open_genes/low_in_all/byquant/", i, ".byquant.txt"))
  all_open_genes[[count]] <- sample_open_genes
  names(all_open_genes)[count] <- i
  count <- count +1
}
...
sig_results <- results[results$p.adj < 0.05,]$gene
sig_results
write_lines(sig_results, paste0(output, "/promoter_patterns/high_gc_sig_open_genes/low_in_all/high_gc_sig_open_genes_byquant.txt"))
prmtr_yes_no[names(prmtr_yes_no) %in% sig_results]
...
write_tsv(stad_enriched_genes_by_prop,
          paste0(output, "/promoter_patterns/ready_to_phenogram/low_in_all/stad_enriched_by_quant.tsv"))
length(healthy_enriched)
...
nrow(healthy_enriched_genes_by_ratio)
write_tsv(healthy_enriched_genes_by_ratio,
          paste0(output, "/promoter_patterns/ready_to_phenogram/low_in_all/healthy_enriched_by_quant.tsv"))
